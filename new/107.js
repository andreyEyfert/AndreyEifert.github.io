...
Template_PriceItem ="<div class=\"price_item wnd_modal\" :is @click=\"in\">\r\n    <input type=\"text\"   :input=\"name\"   @focus placeholder=\"РќР°Р·РІР°РЅРёРµ\">\r\n    <input type=\"number\" :input=\"price\"  @focus placeholder=\"Р¦РµРЅР°\">\r\n    <button @click>Р”РѕР±Р°РІРёС‚СЊ</button>\r\n</div>";
...
Template_WndLogin ="<div class=\"wnd-full login c\" :is>\r\n    <div class=\"wrapper col\">\r\n        <input type=\"text\" :input=\"uname\" placeholder=\"РРјСЏ РџРѕР»СЊР·РѕРІР°С‚РµР»СЏ\">\r\n        <input type=\"password\" :input=\"upass\" placeholder=\"РџР°СЂРѕР»СЊ\">\r\n        <button @click>Р’РѕР№С‚Рё</button>\r\n    </div>\r\n</div>";
